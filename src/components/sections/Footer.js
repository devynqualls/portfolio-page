  ...
  return (
    <StyledFooterRoot ref={footer}>
      ...
      >
        {lg && (
          <StyledFooterList>
            <StyledListItemLink
              ...
              href="https://www.linkedin.com/in/devyn-q/"
              target="_blank"
            >
              <svg
            ...
            <StyledListItemLink
              href="https://github.com/devynqualls"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <StyledListItemLink
              href="mailto:devyn.qualls@gmail.com"
        ...
        <StyledFooterText>Developed by Devyn Qualls</StyledFooterText>
        <StyledFooterText sx={{ marginBottom: "1rem" }}>
          <StyledViewCodeLink href="https://github.com/Devynqualls">
